...
# Give job a name
#$ -N MPNN_spring_mass_pred_acc_no_edges
...
python scripts/train.py -m 'MPNN' -c '/projectnb/biochemai/Grant/interaction_rule_GNN/configs/mpnn.yaml' -d '/projectnb/biochemai/Grant/interaction_rule_GNN/data/spring_mass/static_graph/graphs/trial_0.pkl' -sp '/projectnb/biochemai/Grant/interaction_rule_GNN/results/SpringMass/MPNN/model/pred_acc_no_edges' -lp '/projectnb/biochemai/Grant/interaction_rule_GNN/results/SpringMass/MPNN/logs/pred_acc_no_edges'